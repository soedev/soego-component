module github.com/soedev/soego-component/eoauth2
...
require (
	...
	github.com/soedev/soego v1.0.2
	github.com/soedev/soego-component/egorm v1.0.0
	github.com/soedev/soego-component/eredis v1.0.0
